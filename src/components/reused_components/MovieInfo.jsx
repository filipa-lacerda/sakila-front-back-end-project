...
export default function MovieInfo({API}){
    ...
    useEffect(()=>{
        fetchMovieInfo("POST", payload)
    }, [])

    const movieInfoElement = movieInfo.map(movie => (
                ...
                <div className="row">
                    <div className="col">
                        ...
                        <dl className="row">
                            ...
                            <dd className="col-md-9">{movie.description}</dd>

                            <dt className="col-md-3">Language</dt>
                            <dd className="col-md-9">{movie.language}</dd>

                            <dt className="col-md-3">Length</dt>
                            <dd className="col-md-9">{movie.length} min</dd>    
                            
                            <dt className="col-md-3">Release Year</dt>
                            <dd className="col-md-9">{movie.release_year}</dd>
